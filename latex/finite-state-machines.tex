...
\begin{figure}[h!]\label{fig:FCSR}
  \centering
  \begin{picture}(90,35)(-55,-25)
    %% State of the register
    \put(0,0){\framebox(10,10){$a_{m-1}$}}
    \put(10,0){\framebox(10,10){$a_{m-2}$}}
    \put(20,0){\framebox(10,10){$\dots$}}
    \put(30,0){\framebox(10,10){$a_{1}$}}
    \put(40,0){\framebox(10,10){$a_{0}$}}
    ...
    \put(30,-13){\makebox(10,10){$q_{m-1}$}}
    \put(35,-8.5){\circle{9}}
    \put(40,-13){\makebox(10,10){$q_m$}}
    \put(45,-8.5){\circle{9}}
    ...
    %% div N mod N
    \put(-13,5){\makebox(13,5){mod $N$}}
    \put(-29.5,5){\makebox(13,5){div $N$}}
  \end{picture}
